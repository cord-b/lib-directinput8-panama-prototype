 ...
 * <p>
 * For this singleton to initialize, you must provide an implementation of the generated {@link dev.viskar.lib.dinput8.natives.IDirectInput8W.Initializer Initializer}
 ...
 * <pre>
 * <small>META-INF/services/dev.viskar.lib.dinput8.natives.IDirectInput8W$Initializer:</small>
 ...
 */
@Generated(
    value = { "dev.viskar.lib.codegen.generator.Generator", "dev.viskar.lib.codegen.generator.InterfaceGenerator" },
    comments = """
        from {
           package = dev.viskar.lib.dinput8.natives
           header = dinput_h
...
public interface IDirectInput8W {
  static IDirectInput8W getInstance() {
    return IDirectInput8WSingleton.getInstance();
  }

  default int ConfigureDevices(MemoryAddress x1, MemoryAddress x2, int x3, MemoryAddress x4) {
    return IDirectInput8WStatic.ConfigureDevices(x1, x2, x3, x4);
  }

  default int EnumDevicesBySemantics(MemoryAddress x1, MemoryAddress x2, MemoryAddress x3,
      MemoryAddress x4, int x5) {
    return IDirectInput8WStatic.EnumDevicesBySemantics(x1, x2, x3, x4, x5);
  }

  default int FindDevice(MemoryAddress x1, MemoryAddress x2, MemoryAddress x3) {
    return IDirectInput8WStatic.FindDevice(x1, x2, x3);
  }

  default int Initialize(MemoryAddress x1, int x2) {
    return IDirectInput8WStatic.Initialize(x1, x2);
  }

  default int RunControlPanel(MemoryAddress x1, int x2) {
    return IDirectInput8WStatic.RunControlPanel(x1, x2);
  }

  default int GetDeviceStatus(MemoryAddress x1) {
    return IDirectInput8WStatic.GetDeviceStatus(x1);
  }

  default int EnumDevices(int x1, MemoryAddress x2, MemoryAddress x3, int x4) {
    return IDirectInput8WStatic.EnumDevices(x1, x2, x3, x4);
  }

  default int CreateDevice(MemoryAddress x1, MemoryAddress x2, MemoryAddress x3) {
  ...
  default int QueryInterface(MemoryAddress x1, MemoryAddress x2) {
