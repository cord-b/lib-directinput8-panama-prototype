...
public class DirectInput8Impl implements DirectInput8 {
    ...
    public static DirectInput8 create() {
...
//                false);
    ...
    public int EnumDevices(int dwDevType, Addressable pvRef, int dwFlags, EnumDevicesCallback deviceCallback) {
        ...
        Callback callback = this.prevEnumDevices;
        if (callback == null) {
            this.prevEnumDevices = callback = new Callback(deviceCallback, deviceCallback.allocate());
